 ...
 * @return Возвращает текущий объект */	
	...
	public GradBack setUseCache(boolean use)
	{
		m_bUseCache = use;
		return this;
	}
...
*@return Возвращает текущий объект */
    ...
    public final GradBack getPressedGradBack()
    {
    	return m_pressed;
    }
    public GradBack setDisabledGradBack(GradBack disabled)
    {
    	m_disabled = disabled;
    	return this;
    }
...
/** Действия по установке размеров текущего объекта */	
	...
	protected void onResize(float width, float height) 
	{
        ...
        m_ptFill = null;
	    if(m_bUseCache&&m_arCachePaints!=null)
	    {
	    ...
	    if(m_ptFill==null)
	    {
	        ...
	        if(m_bUseCache)
	        {
	        	if(m_arCachePaints==null)
		    		m_arCachePaints = new Vector<GradBack.PaintEntry>();
...
/** Отрисовка */	
	...
	public void draw(Canvas canvas, Paint paint)
	{
	    ...
	    if(m_ptFill!=null)
	    {
	    	if(m_bDisabled&&m_disabled!=null)
	    	{
	    		Paint p = m_disabled.newPaint();
	    		p.setColor(m_disabled.m_clrStart);
	    		canvas.drawRect(m_rect, p);
	    	}
	    	else if(m_bPressed&&m_pressed!=null)
...
/** Обработчик изменения состояния */	
	public void changeState(int []states)
	{
        ...
        m_bDisabled = !hasState(android.R.attr.state_enabled, states);
	}
